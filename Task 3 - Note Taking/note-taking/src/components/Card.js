...
const Card = ({noteObj, index, deleteNote, updateListArray}) => {
    ...
    return (
        <div class = "card-wrapper mr-5">
            ...
            <div class = "note-holder">
                <span class = "card-header" style={{"background-color": colors[index%5].secondaryColor, "border-radius": "10px"}}>{noteObj.Name}</span>
